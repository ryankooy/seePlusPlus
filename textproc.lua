local filename = "readings.txt"
io.input(filename)

local dates = {}
local duplicated, bad_format = {}, {}
local num_good_records, lines_total = 0, 0
...
while true do
  ...
  local date = string.match(line, "%d+%-%d+%-%d+")
  ...
  dates[date] = 1
  local count_pairs, bad_values = 0, false
